...
Projekt pmk próbuje dostarczyć alternatywę dla GNU autoconfa, GNU
libtoola i pkg-configa. Dostarcza także podstawowe narzędzie podobne
do BSD install i skaner kodu źródłowego pomagający przy tworzeniu
pmkfile'i.

Cele:
- łatwe używanie zarówno dla użytkowników, jak i programistów
- uczynienie etapu configure tak bezpiecznym, jak to możliwe
- utrzymanie jak najmniejszej liczby zależności (właściwie tylko libc)
- dostarczenie pakietu na wolnej i używalnej licencji dla każdego
  (3-klauzulowej BSD)
- ograniczenie zmian w źródłach przy przechodzeniu z autoconfa
